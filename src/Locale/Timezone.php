...
enum Timezone: string implements EnumInterface
{
    ...
    case AFRICA_PORTO_MINUS_NOVO = "Africa/Porto-Novo";
    ...
    case AMERICA_ARGENTINA_COMODRIVADAVIA = "America/Argentina/ComodRivadavia";
    ...
    case AMERICA_BLANC_MINUS_SABLON = "America/Blanc-Sablon";
    ...
    case AMERICA_COYHAIQUE = "America/Coyhaique";
    ...
    case AMERICA_PORT_MINUS_AU_MINUS_PRINCE = "America/Port-au-Prince";
    ...
    case ASIA_UST_MINUS_NERA = "Asia/Ust-Nera";
    ...
    case ETC_GMT_MINUS_0 = "Etc/GMT-0";
    ...
    /**
     * Get the current UTC offset formatted as string (e.g., "+02:00", "-05:00").
     */
    public function getUtcOffsetString(): string
    {
        $offset = $this->getUtcOffset();
